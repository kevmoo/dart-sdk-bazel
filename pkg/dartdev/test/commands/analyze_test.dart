...
''');
  ...
  group('display mode', () {
    ...
    Map<String, Object?> fullDiagnosticJson(TestProject p) => {
      ...
      'correction': "Try moving the declaration to before the first use, or renaming the local variable so that it doesn't hide a name from an enclosing scope.",
    ...
    group('json', () {
      group('--format=json', () {
        ...
        test('priority error', () async {
          ...
          expect(
            stdout,
            startsWith('{"version":1,"diagnostics":[{"code":"parse_error",'),
          );
            ...
            'diagnostics': [
              {
                ...
                'documentation': 'https://dart.dev/diagnostics/referenced_before_declaration',
              },
            ],
          }),
        );
