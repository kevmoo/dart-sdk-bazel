...
- **Overall Progress**: 95/121 Tasks (Completed details in [BACKLOG_HISTORY.md](BACKLOG_HISTORY.md))
...
graph TD
    ...
    sdk_p5r["sdk-p5r:<br>{REC-FAST-5} Add default Bazel flags {--nobuild_runfile_links} to eliminate inode churn"]:::pending
